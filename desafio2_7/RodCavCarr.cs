...
namespace desafio2_7
{
    internal class NewBaseType
    {
        public static string CalcularRod(int digito)
        {
            if (digito == 1 || digito == 2) { return "SEGUNDA"; }
            else if (digito == 3 || digito == 4) { return "TERCA"; }
            else if (digito == 5 || digito == 6) { return "QUARTA"; }
            else if (digito == 7 || digito == 8) { return "QUINTA"; }
            else if (digito == 9 || digito == 0) { return "SEXTA"; }
            else { return "FALHA"; }
        }
